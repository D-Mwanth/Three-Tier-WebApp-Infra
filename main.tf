...
# Create VPC
module "vpc" {
  source         = "git::https://github.com:D-Mwanth/tf-custom-modules.git//vpc?ref=main"
...
module "sg" {
  source           = "git::https://github.com:D-Mwanth/tf-custom-modules.git//sg?ref=main"
...
module "system_manger_endpoints" {
  source            = "git::https://github.com:D-Mwanth/tf-custom-modules.git//ssm?ref=main"
  region            = var.region
  vpc_id            = module.vpc.vpc_id
...
# IAM profile
module "iam" {
  source = "git::https://github.com:D-Mwanth/tf-custom-modules.git//iam?ref=main"
}

# Creating Key pair for instances
module "key" {
  source     = "git::https://github.com:D-Mwanth/tf-custom-modules.git//key?ref=main"
  public_key = var.public_key_path
}

# Database deployment
module "database" {
  source         = "git::https://github.com:D-Mwanth/tf-custom-modules.git//database?ref=main"
...
module "secret_manager" {
  source       = "git::https://github.com:D-Mwanth/tf-custom-modules.git//secret-manager?ref=main"
...
module "app_tier_lb" {
  source           = "git::https://github.com:D-Mwanth/tf-custom-modules.git//lb?ref=main" #/app_lb"
  vpc_id           = module.vpc.vpc_id
...
module "app_tier_asg" {
  source        = "git::https://github.com:D-Mwanth/tf-custom-modules.git//asg?ref=main"
  tier_name     = "app-tier"
...
module "acm" {
  source                     = "git::https://github.com:D-Mwanth/tf-custom-modules.git//acm?ref=main"
...
module "web_tier_lb" {
  source          = "git::https://github.com:D-Mwanth/tf-custom-modules.git//lb?ref=main" #/web_lb"
  vpc_id          = module.vpc.vpc_id
...
module "aws_wafv2" {
  source     = "git::https://github.com:D-Mwanth/tf-custom-modules.git//WAF?ref=main"
...
module "route_53_dns_name" {
  source             = "git::https://github.com:D-Mwanth/tf-custom-modules.git//route53?ref=main"
